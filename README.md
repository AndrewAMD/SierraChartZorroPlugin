# Sierra Chart Plugin for Zorro, version 0.9.2.0

This plugin works both as a broker plugin to Zorro Trading Automaton and as a client to Sierra Chart in order to:
